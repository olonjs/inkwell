  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-background text-foreground px-6">
      <section className="w-full max-w-xl rounded-xl border border-border bg-card p-8 shadow-sm">
        <h1 className="text-2xl font-semibold tracking-tight" data-jp-field="title">{title}</h1>
        <p className="mt-3 text-sm text-muted-foreground" data-jp-field="description">{description}</p>
      </section>
    </main>
  );
}
